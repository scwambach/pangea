  ...
  return (
    <div className="relative">
      ...
      <div className="max-w-[1370px] text-center mx-auto relative flex justify-between items-center tablet-lg:px-4">
        <div className="bg-pangea-translucent tablet-lg:bg-pangea px-4 py-16 tablet-lg:px-[50px] tablet-lg:py-[90px] relative text-white w-full tablet-lg:max-w-[450px] flex flex-col items-center gap-8 z-10">
          {logo({ slug, color: "#fff", className: "h-[152px] w-auto mx-auto" })}
          <PortableText
            value={copy}
            components={
              {
